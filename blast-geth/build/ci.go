...
import (
	...
	"github.com/tenderly/blast/blast-geth/crypto/signify"
	"github.com/tenderly/blast/blast-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/blast/blast-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/blast/blast-geth/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/tenderly/blast/blast-geth/params.gitTag="+env.Tag)
	}
